...
export default function Home() {
  ...
  return (
    <>
        ...
        <section id="ai-features" className="bg-gradient-to-r from-emerald-50/10 via-teal-50/5 to-emerald-50/10 dark:from-emerald-950/5 dark:via-teal-950/3 dark:to-emerald-950/5 py-20">
        ...
        {/* CTA Section */}
        <section id="contact" className="container mx-auto px-4 py-20 text-center bg-transparent">
        ...
        {/* Footer */}
        <footer className="border-t border-emerald-100/50 bg-gradient-to-r from-emerald-50/10 to-teal-50/10 dark:from-emerald-950/5 dark:to-teal-950/5 py-12">
          <div className="container mx-auto px-4">
